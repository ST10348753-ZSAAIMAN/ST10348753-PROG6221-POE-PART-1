...
//             https://www.geeksforgeeks.org/delegates-in-c-sharp/
//             https://www.geeksforgeeks.org/events-in-c-sharp/
//             https://www.tutorialsteacher.com/linq
//             https://www.c-sharpcorner.com/UploadFile/b926a6/generics-in-C-Sharp/
//             https://www.c-sharpcorner.com/UploadFile/0c1bb2/linq-in-C-Sharp/
//             https://www.w3schools.com/linq/
...
namespace ST10348753_PROG6221_POE_PART_2
{
    ...
    internal class Program
    {
        ...
        /// <summary>
        /// Resets the quantities of all ingredients in the selected recipe to their original values.
        /// </summary>
        /// <param name="recipes">The list of recipes to select from.</param>
        private static void ResetRecipeQuantities(List<Recipe> recipes)
        {
            Console.Clear();
            if (recipes.Count == 0)
            {
            ...
            {
                // Prompt for recipe name to reset
